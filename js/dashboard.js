(function($) {
  ...
  $(function() {
    if ($("#performaneLine").length) {
      ...
      saleGradientBg.addColorStop(0, 'rgba(255, 102, 102, 0.18)');
      saleGradientBg.addColorStop(1, 'rgba(250, 244, 244, 0.5)');
    ...
    if ($("#performaneLine-dark").length) {
      ...
      //saleGradientBg.addColorStop(0, 'rgba(255, 102, 102, 0.18)');
      //saleGradientBg.addColorStop(1, 'rgba(255, 102, 102, 0.5)');
